...
export const STORY_DATA: Record<string, Scene> = {
  intro: {
    ...
    imageUrl: './public/assets/intro.mp4',
    choices: [
...
signs_struggle: {
  ...
  imageUrl: './public/assets/signs_struggle.mp4',
  choices: [
  ...
  inspect_body: {
    ...
    imageUrl: './public/assets/inspect-body.mp4',
    choices: [
  ...
  talk_officer: {
    ...
    imageUrl: './public/assets/talk-officer.mp4',
    choices: [
  ...
  extract_chip: {
    ...
    imageUrl: './public/assets/extract-chip.mp4',
    choices: [
  ...
  neon_lotus_entry: {
    ...
    imageUrl: './public/assets/neon_lotus_entry.mp4',
    choices: [
  ...
  decrypt_failure: {
    ...
    imageUrl: './public/assets/.mp4decrypt-fail/1200/600',
    choices: [
  ...
  bad_ending_framed: {
    ...
    imageUrl: './public/assets/.mp4framed-ending/1200/600',
    choices: [
  ...
  good_ending_solved: {
    ...
    imageUrl: './public/assets/.mp4good-ending/1200/600',
    choices: [
